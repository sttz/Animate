...
public enum TweenOverwrite
{
	...
	/// after the tween was created or when <see cref="Tween.Validate"/> is
	/// called.
	/// </summary>
	OnInitialize = 1,
	/// <summary>
...
/// <summary>
/// Tween timing defines when a tween is updated and what time
/// it's being calculated with.
/// </summary>
[Flags]
...
public enum TweenState
{
	...
	/// <see cref="Tween.Validate"/>.
	/// </summary>
	Uninitialized,
	/// <summary>
	/// The tween is waiting to start, e.g. because 
	/// <see cref="TweenOptions.StartDelay"/> has been set.
	/// </summary>
	Waiting,
	/// <summary>
	...
	Complete,
	/// <summary>
	/// The tween has encountered an error. See <see cref="Tween.Error"/>
...
/// <seealso cref="Tween.CompletedBy"/>
[Flags]
